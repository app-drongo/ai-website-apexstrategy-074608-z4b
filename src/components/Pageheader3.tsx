      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative py-16 sm:py-20 lg:py-24 max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl">
            Ready to transform your organization? Connect with our team of Fortune 500 consultants to discuss 
            your strategic challenges and explore how we can drive measurable results for your business.
          </p>
        </div>
      </div>
    </section>
