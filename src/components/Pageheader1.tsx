      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative py-16 sm:py-20 lg:py-24 max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl">
            Explore real transformation stories from industry leaders who partnered with Apex Strategy Consultants 
            to achieve operational excellence and drive sustainable business growth across their organizations.
          </p>
        </div>
      </div>
    </section>
