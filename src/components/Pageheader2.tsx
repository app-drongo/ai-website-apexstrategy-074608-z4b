      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative py-16 sm:py-20 lg:py-24 max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl">
            For over 25 years, Apex Strategy Consultants has been the trusted partner for Fortune 500 companies 
            seeking transformational change, operational excellence, and sustainable competitive advantage in dynamic markets.
          </p>
        </div>
      </div>
    </section>
