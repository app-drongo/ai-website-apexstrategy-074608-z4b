...
export default function Cta() {
  const stats = [
    ...
    { value: "25+", label: "Years Experience", icon: Target }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join the Fortune 500 companies who have achieved operational excellence and sustainable growth 
                through our proven strategic consulting methodologies.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by Fortune 500 leaders across industries
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Strategic evaluation with no obligation
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Battle-tested frameworks with measurable ROI
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Fast-track your transformation with expert guidance
              </p>
            </div>
          </div>
        </div>
