      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative py-16 sm:py-20 lg:py-24 max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl">
            Apex Strategy Consultants delivers comprehensive business transformation solutions tailored for Fortune 500 companies. 
            Our proven methodologies drive sustainable growth, optimize operations, and accelerate strategic initiatives across all industries.
          </p>
        </div>
      </div>
    </section>
